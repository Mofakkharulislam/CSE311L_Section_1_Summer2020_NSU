...
$sql ="INSERT INTO Employee_table(Employee_Id,First_Name,Last_Name,Email,Phone_Number,Hire_Date,Job_Id,Salary,Commission_pct,Manager_id,Department_Id) VALUES
    (100, 'Steven', 'King', 'SKING', '515.123.4567', '1987-06-17', 'AD_PRESS', 24000, NULL, NULL, 90),
    (101, 'Neena', 'Kochar', 'NKOCHHAR', '515.123.4568', '1989-09-21', 'AD_VP', 17000, NULL, 100, 90),
    (102, 'Lex', 'De Haan', 'LDEHAAN', '515.123.4569', '1989-09-21', 'AD_VP', 17000, NULL, 100, 90),
    (103, 'Alexander', 'Hunold', 'AHUNOLD', '515.423.4567', '1989-09-21', 'IT_PROG', 9000, NULL, 102, 60),
    ...
    (149, 'Eleni', 'Zlotkey', 'EZLOTKEY', '011.44.1344.429018', '2000-01-09', 'SA_MAN', 10500, .2, 100, 80),
    ...
    (201, 'Micheal', 'Hartstein', 'MHARTSTE', '515.123.5555', '1996-02-17', 'MK_MAN', 13000, NULL, 100, 20),
    ...
    (206, 'William', 'Gietz', 'WGIETZ', '515.123.8181', '1947-06-07', 'AC_ACCOUNT', 8300, NULL, 205, 110)";
